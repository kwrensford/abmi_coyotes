...
covars_boreal <- covars[covars$location %in% rownames(coyotecounts_boreal), ]
...
coyote_nmix_boreal
plotEffects(coyote_nmix_boreal, type = "state", covariate = "PC1")
plotEffects(coyote_nmix_boreal, type = "state", covariate = "PC2")
plotEffects(coyote_nmix_boreal, type = "state", covariate = "hf")
```
