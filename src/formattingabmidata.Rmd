...
boreal_main_reports <- study_main_reports %>%
  filter(NR == "Boreal")
```
...
##Coyote boreal
coyoteabundancehistory_boreal <-detectionHistory(recordTable = boreal_main_reports,
                                         camOp = camera_operation_matrix,
                                         output = "count",
                                         stationCol = "location",
                                         speciesCol = "species_common_name",
...
coyotecounts_boreal <-coyoteabundancehistory_boreal$detection_history
write.csv(coyotecounts, file = "data/coyotecounts_boreal.csv", row.names = FALSE)
...
coyotecounts_boreal <- coyotecounts_boreal[common_sites,]
